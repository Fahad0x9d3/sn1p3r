...
print $header;
$footer = '<font color="#60c0ff"><tr><td><hr><center><font color="red"><b>&copy; <font color="lime">2011-2014  <font color="red">By : <font color="red"> Challenges HackerS  </center></td></table></body></head></html>';
...
case 'about':
  echo '<center>
<font color="red" size="7">Challenges Hackers';
   echo '<table border="1" width="460" style="border:1px dotted red;  color:#FFB200; font-family:Tahoma; font-size:8pt; background-color:#000000">
				<tr>
					<td><font color="#00FF00">DrZ3R0</font></td>
					<td><font color="#00FF00">Ml7s-Hacker</font></td>
				</tr>
				<tr>
					<td><font color="#00FF00">DrZero@Live.CoM</font></td>
					<td><font color="#00FF00">error@HoTmail.CoM</font></td>
				</tr>
			</table>
